...
function setOptions(ioValue: ISysInfoIOStatistics) {
  ...
  option.value.series[0].data.push(Utils.bytesToMB(ioValue.bytes_sent))
  option.value.series[1].data.push(Utils.bytesToMB(ioValue.bytes_recv))
  headerList.value[0].value = Utils.formatBytes(ioValue.bytes_sent)
  headerList.value[1].value = Utils.formatBytes(ioValue.bytes_recv)
  headerList.value[2].value = Utils.formatBytes(ioValue.total_bytes_sent)
  headerList.value[3].value = Utils.formatBytes(ioValue.total_bytes_recv)
}
